...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.renderTableElement = exports.changeWinnersAndGarageBlock = exports.changePages = void 0;
const api_1 = __webpack_require__(/*! ./api */ "./modules/api.ts");
const createCarElement_1 = __webpack_require__(/*! ./createCarElement */ "./modules/createCarElement.ts");
    ...
    raceButton.addEventListener('click', (event) => {
        ...
        Promise.any(promiseArr)
            ...
            if (value.property.firstWin) {
                console.log('CREATE');
                return (0, createHtmlElements_1.createTableRow)(value.car, (await value.property.f.then(value => value)).valueOf());
            }
            else {
                console.log('UPDATE');
                return (0, createHtmlElements_1.changeTableRow)(value.car, (await value.property.f.then(value => value)).valueOf());
            }
        });
    });
}
